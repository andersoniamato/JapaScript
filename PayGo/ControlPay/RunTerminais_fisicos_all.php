      ...
      foreach ($response->pessoas as $pessoa){
        ...
        $cpf_cnpj = $pessoa->cpfCnpj;
                  ...
                  $curl_setopt_array = curl_setopt_array($curl, array(
                    ...
                    //atribui a URL da API para a variável $url
                    CURLOPT_URL => "http://ControlPay.ntk.com.br/webapi/Terminal/GetByPessoaId?key=$key&pessoaId=$id_pessoa",
                  ...
                  foreach ($response2->terminais as $terminal) {

                    $terminal_fisico = $terminal->terminalFisico->id;

                    if ($terminal_fisico != null) {
                      echo "
                          <tr>
                            <td>".$cpf_cnpj."</td>
                            <td>".$terminal_fisico."</td>
